 QuizCraft This is a lightweight interactive quiz application built with HTML, CSS, and JavaScript (no frameworks). It includes user authentication, quiz taking, score tracking, and an admin dashboard.
